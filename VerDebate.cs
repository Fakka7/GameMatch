...
namespace GameMatch
{
    public partial class VerDebate : Form
    {
        string texto = "";
        public VerDebate(string texto)
        {
            this.texto = texto;
            InitializeComponent();
            ...
            using (MySqlConnection conexion1 = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string consulta = "SELECT Juego, Texto FROM debates WHERE Texto = @texto";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conexion2 = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string consulta = "UPDATE debates SET juego = @juego, Texto = @textomod WHERE Texto = @texto;";
